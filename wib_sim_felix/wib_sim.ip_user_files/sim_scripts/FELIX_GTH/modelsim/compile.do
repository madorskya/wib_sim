...
vlog -work xpm -64 -incr -sv -L axi_vip_v1_1_7 -L zynq_ultra_ps_e_vip_v1_0_7 -L xilinx_vip "+incdir+/opt/Xilinx/Vivado/2020.1/data/xilinx_vip/include" \
...
vlog -work gtwizard_ultrascale_v1_7_8 -64 -incr "+incdir+/opt/Xilinx/Vivado/2020.1/data/xilinx_vip/include" \
