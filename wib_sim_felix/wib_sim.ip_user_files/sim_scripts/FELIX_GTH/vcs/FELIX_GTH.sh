...
#
# Generated by Vivado on Mon Nov 09 13:19:02 EST 2020
# SW Build 2902540 on Wed May 27 19:54:35 MDT 2020
#
# Copyright 1986-2020 Xilinx, Inc. All Rights Reserved. 
#
# usage: FELIX_GTH.sh [-help]
# usage: FELIX_GTH.sh [-lib_map_path]
# usage: FELIX_GTH.sh [-noclean_files]
# usage: FELIX_GTH.sh [-reset_run]
#
...
# executing this script. Please type 'FELIX_GTH.sh -help' for more information.
#
...
# Design libraries
design_libs=(xilinx_vip xpm gtwizard_ultrascale_v1_7_8 xil_defaultlib)

# Simulation root library directory
sim_lib_dir="vcs_lib"

# Script info
echo -e "FELIX_GTH.sh - Script generated by export_simulation (Vivado v2020.1 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"/opt/Xilinx/Vivado/2020.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"/opt/Xilinx/Vivado/2020.1/data/xilinx_vip/include" \
  ...
  vlogan -work gtwizard_ultrascale_v1_7_8 $vlogan_opts +v2k +incdir+"/opt/Xilinx/Vivado/2020.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"/opt/Xilinx/Vivado/2020.1/data/xilinx_vip/include" \
    "$ref_dir/../../../../wib_sim.srcs/sources_1/ip/FELIX_GTH/sim/gtwizard_ultrascale_v1_7_gthe4_channel.v" \
    "$ref_dir/../../../../wib_sim.srcs/sources_1/ip/FELIX_GTH/sim/FELIX_GTH_gthe4_channel_wrapper.v" \
    "$ref_dir/../../../../wib_sim.srcs/sources_1/ip/FELIX_GTH/sim/gtwizard_ultrascale_v1_7_gthe4_common.v" \
    "$ref_dir/../../../../wib_sim.srcs/sources_1/ip/FELIX_GTH/sim/FELIX_GTH_gthe4_common_wrapper.v" \
    "$ref_dir/../../../../wib_sim.srcs/sources_1/ip/FELIX_GTH/sim/FELIX_GTH_gtwizard_gthe4.v" \
    "$ref_dir/../../../../wib_sim.srcs/sources_1/ip/FELIX_GTH/sim/FELIX_GTH_gtwizard_top.v" \
    "$ref_dir/../../../../wib_sim.srcs/sources_1/ip/FELIX_GTH/sim/FELIX_GTH.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.FELIX_GTH xil_defaultlib.glbl -o FELIX_GTH_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./FELIX_GTH_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./FELIX_GTH.sh -help\" for more information)\n"
        exit 1
      fi
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/lxeng99/DUNE/wib_sim_felix/wib_sim_felix/wib_sim.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key FELIX_GTH_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc FELIX_GTH_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./FELIX_GTH.sh -help\" for more information)\n"
    exit 1
  fi
