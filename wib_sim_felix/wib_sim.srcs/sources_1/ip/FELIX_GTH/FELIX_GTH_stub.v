...
//               /home/lxeng99/DUNE/FELIX/WIB_GTH_felix/WIB_GTH_felix.srcs/sources_1/ip/FELIX_GTH/FELIX_GTH_stub.v
// Design      : FELIX_GTH
...
(* X_CORE_INFO = "FELIX_GTH_gtwizard_top,Vivado 2020.1" *)
module FELIX_GTH(gtwiz_userclk_tx_reset_in, 
  ...
  qpll1outclk_out, qpll1outrefclk_out, gthrxn_in, gthrxp_in, rx8b10ben_in, rxbufreset_in, 
  rxchbonden_in, rxchbondi_in, rxchbondlevel_in, rxchbondmaster_in, rxchbondslave_in, 
  rxcommadeten_in, rxmcommaalignen_in, rxpcommaalignen_in, tx8b10ben_in, txctrl0_in, 
  txctrl1_in, txctrl2_in, gthtxn_out, gthtxp_out, gtpowergood_out, rxbufstatus_out, 
  rxbyteisaligned_out, rxbyterealign_out, rxchanbondseq_out, rxchanisaligned_out, 
  rxchanrealign_out, rxchbondo_out, rxclkcorcnt_out, rxcommadet_out, rxctrl0_out, 
  rxctrl1_out, rxctrl2_out, rxctrl3_out, rxpmaresetdone_out, txpmaresetdone_out)
