...
-- START automatically generated VHDL (Sun Mar 13 13:13:11 2022)
  constant N_SLV_NZ_RST_CTRL: integer := 0;
  constant N_SLV_PACKET_COUNTERS: integer := 1;
  constant N_SLV_ID_STAT: integer := 2;
...
-- START automatically generated VHDL (Sun Mar 13 13:13:11 2022)
    if    std_match(addr, "--------------------------00----") then
      ...
      sel := ipbus_sel_t(to_unsigned(N_SLV_PACKET_COUNTERS, IPBUS_SEL_WIDTH)); -- packet_counters / base 0x00000010 / mask 0x00000030
    elsif std_match(addr, "--------------------------10----") then
      sel := ipbus_sel_t(to_unsigned(N_SLV_ID_STAT, IPBUS_SEL_WIDTH)); -- id_stat / base 0x00000020 / mask 0x00000030
-- END automatically generated VHDL
