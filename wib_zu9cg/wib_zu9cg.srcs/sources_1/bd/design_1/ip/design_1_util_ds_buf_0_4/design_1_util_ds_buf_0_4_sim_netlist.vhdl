...
--               c:/github/wib_sim/wib_zu9cg/wib_zu9cg.srcs/sources_1/bd/design_1/ip/design_1_util_ds_buf_0_4/design_1_util_ds_buf_0_4_sim_netlist.vhdl
...
entity design_1_util_ds_buf_0_4_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of design_1_util_ds_buf_0_4_util_ds_buf : entity is 1;
  attribute C_BUFG_GT_SYNC : integer;
  attribute C_BUFG_GT_SYNC of design_1_util_ds_buf_0_4_util_ds_buf : entity is 0;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of design_1_util_ds_buf_0_4_util_ds_buf : entity is "BUFG";
  attribute C_OBUFDS_GTE5_ADV : string;
  attribute C_OBUFDS_GTE5_ADV of design_1_util_ds_buf_0_4_util_ds_buf : entity is "2'b00";
  attribute C_REFCLK_ICNTL_TX : string;
  attribute C_REFCLK_ICNTL_TX of design_1_util_ds_buf_0_4_util_ds_buf : entity is "5'b00000";
  attribute C_SIM_DEVICE : string;
  attribute C_SIM_DEVICE of design_1_util_ds_buf_0_4_util_ds_buf : entity is "VERSAL_AI_CORE_ES1";
  attribute C_SIZE : integer;
  attribute C_SIZE of design_1_util_ds_buf_0_4_util_ds_buf : entity is 1;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_util_ds_buf_0_4_util_ds_buf : entity is "util_ds_buf";
end design_1_util_ds_buf_0_4_util_ds_buf;

architecture STRUCTURE of design_1_util_ds_buf_0_4_util_ds_buf is
  signal \<const0>\ : STD_LOGIC;
  attribute XILINX_LEGACY_PRIM : string;
  attribute XILINX_LEGACY_PRIM of \USE_BUFG.GEN_BUFG[0].BUFG_U\ : label is "BUFG";
...
\USE_BUFG.GEN_BUFG[0].BUFG_U\: unisim.vcomponents.BUFGCE
    generic map(
      CE_TYPE => "ASYNC",
...
entity design_1_util_ds_buf_0_4 is
  ...
  attribute NotValidForBitStream of design_1_util_ds_buf_0_4 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_util_ds_buf_0_4 : entity is "design_1_util_ds_buf_0_4,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_util_ds_buf_0_4 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of design_1_util_ds_buf_0_4 : entity is "util_ds_buf,Vivado 2020.1.1_AR73018";
end design_1_util_ds_buf_0_4;

architecture STRUCTURE of design_1_util_ds_buf_0_4 is
  ...
  attribute x_interface_parameter of BUFG_I : signal is "XIL_INTERFACENAME BUFG_I, FREQ_HZ 40000000, FREQ_TOLERANCE_HZ 0, PHASE 0.000, CLK_DOMAIN design_1_zynq_ultra_ps_e_0_0_pl_clk1, INSERT_VIP 0";
  attribute x_interface_info of BUFG_O : signal is "xilinx.com:signal:clock:1.0 BUFG_O CLK";
  attribute x_interface_parameter of BUFG_O : signal is "XIL_INTERFACENAME BUFG_O, FREQ_HZ 40000000, FREQ_TOLERANCE_HZ 0, PHASE 0.000, CLK_DOMAIN design_1_zynq_ultra_ps_e_0_0_pl_clk1, INSERT_VIP 0";
begin
U0: entity work.design_1_util_ds_buf_0_4_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_CLR(0) => '0',
      BUFGCE_I(0) => '0',
