...
name+=(felix_tx_rst_done felix_tx_active felix_pwr_good felix_rst_pll felix_rst_datapath felix_tx8b10b_en)
addr+=(0xA00C00C0        0xA00C00C0      0xA00C00C0     0xA00C0038    0xA00C0038         0xA00C0038 )
bnum+=(0                 4               8              0             4                  8)
mask+=(1                 1               1              1             1                  3)
