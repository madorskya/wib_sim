...
(
    ...
    begin
        ...
        begin
            ...
            parallel_daq_1 [0 +: 14] = deframed_mapped [1][0][0];
            parallel_daq_1 [14 +: 14] = deframed_mapped [1][0][1];
            parallel_daq_1 [28 +: 14] = deframed_mapped [1][0][2];
            parallel_daq_1 [42 +: 14] = deframed_mapped [1][0][3];
            parallel_daq_1 [56 +: 14] = deframed_mapped [1][0][4];
            parallel_daq_1 [70 +: 14] = deframed_mapped [1][0][5];
            parallel_daq_1 [84 +: 14] = deframed_mapped [1][0][6];
            parallel_daq_1 [98 +: 14] = deframed_mapped [1][0][7];
            parallel_daq_1 [112 +: 14] = deframed_mapped [1][0][8];
            parallel_daq_1 [126 +: 14] = deframed_mapped [1][0][9];
            parallel_daq_1 [140 +: 14] = deframed_mapped [1][0][10];
            parallel_daq_1 [154 +: 14] = deframed_mapped [1][0][11];
            parallel_daq_1 [168 +: 14] = deframed_mapped [1][0][12];
            parallel_daq_1 [182 +: 14] = deframed_mapped [1][0][13];
            parallel_daq_1 [196 +: 14] = deframed_mapped [1][0][14];
            parallel_daq_1 [210 +: 14] = deframed_mapped [1][0][15];
            parallel_daq_1 [224 +: 14] = deframed_mapped [1][1][0];
            parallel_daq_1 [238 +: 14] = deframed_mapped [1][1][1];
            parallel_daq_1 [252 +: 14] = deframed_mapped [1][1][2];
            parallel_daq_1 [266 +: 14] = deframed_mapped [1][1][3];
            parallel_daq_1 [280 +: 14] = deframed_mapped [1][1][4];
            parallel_daq_1 [294 +: 14] = deframed_mapped [1][1][5];
            parallel_daq_1 [308 +: 14] = deframed_mapped [1][1][6];
            parallel_daq_1 [322 +: 14] = deframed_mapped [1][1][7];
            parallel_daq_1 [336 +: 14] = deframed_mapped [1][1][8];
            parallel_daq_1 [350 +: 14] = deframed_mapped [1][1][9];
            parallel_daq_1 [364 +: 14] = deframed_mapped [1][1][10];
            parallel_daq_1 [378 +: 14] = deframed_mapped [1][1][11];
            parallel_daq_1 [392 +: 14] = deframed_mapped [1][1][12];
            parallel_daq_1 [406 +: 14] = deframed_mapped [1][1][13];
            parallel_daq_1 [420 +: 14] = deframed_mapped [1][1][14];
            parallel_daq_1 [434 +: 14] = deframed_mapped [1][1][15];
            parallel_daq_1 [448 +: 14] = deframed_mapped [1][2][0];
            parallel_daq_1 [462 +: 14] = deframed_mapped [1][2][1];
            parallel_daq_1 [476 +: 14] = deframed_mapped [1][2][2];
            parallel_daq_1 [490 +: 14] = deframed_mapped [1][2][3];
            parallel_daq_1 [504 +: 14] = deframed_mapped [1][2][4];
            parallel_daq_1 [518 +: 14] = deframed_mapped [1][2][5];
            parallel_daq_1 [532 +: 14] = deframed_mapped [1][2][6];
            parallel_daq_1 [546 +: 14] = deframed_mapped [1][2][7];
            parallel_daq_1 [560 +: 14] = deframed_mapped [1][2][8];
            parallel_daq_1 [574 +: 14] = deframed_mapped [1][2][9];
            parallel_daq_1 [588 +: 14] = deframed_mapped [1][2][10];
            parallel_daq_1 [602 +: 14] = deframed_mapped [1][2][11];
            parallel_daq_1 [616 +: 14] = deframed_mapped [1][2][12];
            parallel_daq_1 [630 +: 14] = deframed_mapped [1][2][13];
            parallel_daq_1 [644 +: 14] = deframed_mapped [1][2][14];
            parallel_daq_1 [658 +: 14] = deframed_mapped [1][2][15];
            parallel_daq_1 [672 +: 14] = deframed_mapped [1][3][0];
            parallel_daq_1 [686 +: 14] = deframed_mapped [1][3][1];
            parallel_daq_1 [700 +: 14] = deframed_mapped [1][3][2];
            parallel_daq_1 [714 +: 14] = deframed_mapped [1][3][3];
            parallel_daq_1 [728 +: 14] = deframed_mapped [1][3][4];
            parallel_daq_1 [742 +: 14] = deframed_mapped [1][3][5];
            parallel_daq_1 [756 +: 14] = deframed_mapped [1][3][6];
            parallel_daq_1 [770 +: 14] = deframed_mapped [1][3][7];
            parallel_daq_1 [784 +: 14] = deframed_mapped [1][3][8];
            parallel_daq_1 [798 +: 14] = deframed_mapped [1][3][9];
            parallel_daq_1 [812 +: 14] = deframed_mapped [1][3][10];
            parallel_daq_1 [826 +: 14] = deframed_mapped [1][3][11];
            parallel_daq_1 [840 +: 14] = deframed_mapped [1][3][12];
            parallel_daq_1 [854 +: 14] = deframed_mapped [1][3][13];
            parallel_daq_1 [868 +: 14] = deframed_mapped [1][3][14];
            parallel_daq_1 [882 +: 14] = deframed_mapped [1][3][15];
        end
        else
        begin
            // Mono FEMB UVX map
