...
--               /home/madorsky/github/zynq/wib_felix/wib_zu6cg/wib_zu6cg.srcs/sources_1/bd/design_1/ip/design_1_debug_bridge_1_0/bd_0/ip/ip_1/bd_0412_lut_buffer_0_sim_netlist.vhdl
...
entity bd_0412_lut_buffer_0_lut_buffer_v2_0_0_lut_buffer is
  port (
    tms_i : in STD_LOGIC;
    tdi_i : in STD_LOGIC;
    tck_i : in STD_LOGIC;
...
architecture STRUCTURE of bd_0412_lut_buffer_0_lut_buffer_v2_0_0_lut_buffer is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity bd_0412_lut_buffer_0 is
  port (
    tdi_i : in STD_LOGIC;
    tms_i : in STD_LOGIC;
    tck_i : in STD_LOGIC;
  ...
  attribute X_CORE_INFO of bd_0412_lut_buffer_0 : entity is "lut_buffer_v2_0_0_lut_buffer,Vivado 2020.1.1_AR73018";
end bd_0412_lut_buffer_0;

architecture STRUCTURE of bd_0412_lut_buffer_0 is
...
begin
inst: entity work.bd_0412_lut_buffer_0_lut_buffer_v2_0_0_lut_buffer
     port map (
      bscanid_en_i => bscanid_en_i,
