...
cmd_bit_sync_i_19: unisim.vcomponents.LUT5
    generic map(
      INIT => X"82000082"
    )
        port map (
...
cmd_bit_sync_i_6: unisim.vcomponents.LUT5
    generic map(
      INIT => X"01000000"
    )
        port map (
...
ts_valid_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0002"
    )
        port map (
...
ts_valid_i_2: unisim.vcomponents.LUT6
    generic map(
