...
module design_1_ts_reclock_0_0(stat_in, rst_in, rdy_in, sync_in, sync_stb_in, 
  tstamp_in, stat_out, rst_out, rdy_out, sync_out, sync_stb_out, tstamp_out, ts_valid, clk62p5, 
  fifo_rst, cmd_code_idle, cmd_code_edge, cmd_code_sync, cmd_code_act, cmd_code_reset, 
  cmd_code_adc_reset, cmd_code_trigger, cmd_en_idle, cmd_en_edge, cmd_en_sync, cmd_en_act, 
  cmd_en_reset, cmd_en_adc_reset, cmd_en_trigger, cmd_bit_idle, cmd_bit_edge, cmd_bit_sync, 
  cmd_bit_act, cmd_bit_reset, cmd_bit_adc_reset, cmd_bit_trigger, fake_time_stamp_en, 
  fake_time_stamp_init, cmd_stamp_sync, cmd_stamp_sync_en)
/* synthesis syn_black_box black_box_pad_pin="stat_in[3:0],rst_in,rdy_in,sync_in[7:0],sync_stb_in,tstamp_in[63:0],stat_out[3:0],rst_out,rdy_out,sync_out[7:0],sync_stb_out,tstamp_out[63:0],ts_valid,clk62p5,fifo_rst,cmd_code_idle[7:0],cmd_code_edge[7:0],cmd_code_sync[7:0],cmd_code_act[7:0],cmd_code_reset[7:0],cmd_code_adc_reset[7:0],cmd_code_trigger[7:0],cmd_en_idle,cmd_en_edge,cmd_en_sync,cmd_en_act,cmd_en_reset,cmd_en_adc_reset,cmd_en_trigger,cmd_bit_idle,cmd_bit_edge,cmd_bit_sync,cmd_bit_act,cmd_bit_reset,cmd_bit_adc_reset,cmd_bit_trigger,fake_time_stamp_en,fake_time_stamp_init[63:0],cmd_stamp_sync[14:0],cmd_stamp_sync_en" */;
  input [3:0]stat_in;
  input rst_in;
  input rdy_in;
  input [7:0]sync_in;
