...
# module references:
# dyn_phase_adjust, spi_mux, daq_spy_control, daq_spy_control, pdts_endpoint_stdlogic, ts_reclock
...
proc create_hier_cell_timing_module { parentCell nameHier } {
  ...
  connect_bd_net -net pdts_endpoint_stdlog_0_clkx2 [get_bd_pins clk_125] [get_bd_pins pdts_endpoint_stdlog_0/clkx2]
...
proc create_root_design { parentCell } {
  ...
  set mon_adc_cs [ create_bd_port -dir O mon_adc_cs ]
  set mon_adc_sck [ create_bd_port -dir IO mon_adc_sck ]
  set mon_adc_sdo [ create_bd_port -dir IO -from 3 -to 0 mon_adc_sdo ]
  ...
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_SPI_0 [get_bd_intf_pins spi_mux_0/adc_spi] [get_bd_intf_pins zynq_ultra_ps_e_0/SPI_0]

  # Create port connections
  connect_bd_net -net Net [get_bd_ports mon_adc_sck] [get_bd_pins spi_mux_0/adc_sck]
  connect_bd_net -net Net1 [get_bd_ports mon_adc_sdo] [get_bd_pins spi_mux_0/adc_sdo]
  ...
  connect_bd_net -net spi_mux_0_adc_cs [get_bd_ports mon_adc_cs] [get_bd_pins spi_mux_0/adc_cs]
