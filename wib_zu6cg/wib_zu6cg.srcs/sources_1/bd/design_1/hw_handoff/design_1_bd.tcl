...
# module references:
# daq_spy_control, daq_spy_control, pdts_endpoint
...
proc create_hier_cell_timing_module { parentCell nameHier } {
  ...
  create_bd_pin -dir O -from 3 -to 0 ts_stat
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT1_JITTER {135.431} \
   CONFIG.CLKOUT1_PHASE_ERROR {130.028} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {62.5} \
   CONFIG.MMCM_CLKFBOUT_MULT_F {19.250} \
  ...
  set block_name pdts_endpoint
  set block_cell_name pdts_endpoint_0
  if { [catch {set pdts_endpoint_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $pdts_endpoint_0 eq "" } {
  ...
  connect_bd_net -net clk_wiz_1_clk_out1 [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins pdts_endpoint_0/rec_clk]
  ...
  connect_bd_net -net pdts_endpoint_0_stat [get_bd_pins ts_stat] [get_bd_pins pdts_endpoint_0/stat]
  ...
  connect_bd_net -net rec_d_clk_0_1 [get_bd_pins ts_rec_d_clk] [get_bd_pins clk_wiz_1/clk_in1] [get_bd_pins pdts_endpoint_0/rec_d_clk]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins Op1] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net sclk_1 [get_bd_pins sclk] [get_bd_pins pdts_endpoint_0/sclk]
  connect_bd_net -net ts_cdr_lol_1 [get_bd_pins ts_cdr_lol] [get_bd_pins pdts_endpoint_0/cdr_lol]
  connect_bd_net -net ts_cdr_los_1 [get_bd_pins ts_cdr_los] [get_bd_pins pdts_endpoint_0/cdr_los]
  connect_bd_net -net ts_rec_clk_locked_1 [get_bd_pins ts_rec_clk_locked] [get_bd_pins pdts_endpoint_0/rec_clk_locked]
  connect_bd_net -net ts_rec_d_1 [get_bd_pins ts_rec_d] [get_bd_pins pdts_endpoint_0/rec_d]
  connect_bd_net -net ts_sfp_los_1 [get_bd_pins ts_sfp_los] [get_bd_pins pdts_endpoint_0/sfp_los]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins clk_wiz_1/reset] [get_bd_pins pdts_endpoint_0/srst] [get_bd_pins util_vector_logic_0/Res]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__CRF_APB__TOPSW_MAIN_CTRL__ACT_FREQMHZ {355.555542} \
   ...
   CONFIG.SUBPRESET1 {DDR4_KINGSTON_KVR21SE15S8} \
  ...
  connect_bd_net -net timing_module_ts_evtctr [get_bd_ports ts_evtctr] [get_bd_pins timing_module/ts_evtctr]
  connect_bd_net -net timing_module_ts_rdy [get_bd_ports ts_rdy] [get_bd_pins timing_module/ts_rdy]
  connect_bd_net -net timing_module_ts_rst [get_bd_ports ts_rst] [get_bd_pins timing_module/ts_rst]
  connect_bd_net -net timing_module_ts_stat [get_bd_ports ts_stat] [get_bd_pins timing_module/ts_stat]
  connect_bd_net -net timing_module_ts_sync [get_bd_ports ts_sync] [get_bd_pins timing_module/ts_sync]
  connect_bd_net -net timing_module_ts_sync_v [get_bd_ports ts_sync_v] [get_bd_pins timing_module/ts_sync_v]
  connect_bd_net -net ts_cdr_lol_1 [get_bd_ports ts_cdr_lol] [get_bd_pins timing_module/ts_cdr_lol]
  connect_bd_net -net ts_cdr_los_1 [get_bd_ports ts_cdr_los] [get_bd_pins timing_module/ts_cdr_los]
  connect_bd_net -net ts_rec_clk_locked_1 [get_bd_ports ts_rec_clk_locked] [get_bd_pins timing_module/ts_rec_clk_locked]
  connect_bd_net -net ts_rec_d_1 [get_bd_ports ts_rec_d] [get_bd_pins timing_module/ts_rec_d]
  connect_bd_net -net ts_sfp_los_1 [get_bd_ports ts_sfp_los] [get_bd_pins timing_module/ts_sfp_los]
