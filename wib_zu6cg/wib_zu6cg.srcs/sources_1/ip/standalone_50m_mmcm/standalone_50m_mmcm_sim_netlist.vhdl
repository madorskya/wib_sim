...
-- Date        : Thu Jun  3 13:47:45 2021
-- Host        : lxeng99 running 64-bit Ubuntu 16.04.6 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/lxeng99/DUNE/wib_sim_timing_sync/wib_zu6cg/wib_zu6cg.srcs/sources_1/ip/standalone_50m_mmcm/standalone_50m_mmcm_sim_netlist.vhdl
...
entity standalone_50m_mmcm_standalone_50m_mmcm_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of standalone_50m_mmcm_standalone_50m_mmcm_clk_wiz : entity is "standalone_50m_mmcm_clk_wiz";
end standalone_50m_mmcm_standalone_50m_mmcm_clk_wiz;

architecture STRUCTURE of standalone_50m_mmcm_standalone_50m_mmcm_clk_wiz is
  signal clk_in1_standalone_50m_mmcm : STD_LOGIC;
  signal clk_out1_standalone_50m_mmcm : STD_LOGIC;
  signal clk_out2_standalone_50m_mmcm : STD_LOGIC;
  signal clk_out3_standalone_50m_mmcm : STD_LOGIC;
...
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_standalone_50m_mmcm,
      O => clk_out1
    );
...
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKIN1 => clk_in1_standalone_50m_mmcm,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_standalone_50m_mmcm,
...
entity standalone_50m_mmcm is
  ...
  attribute NotValidForBitStream of standalone_50m_mmcm : entity is true;
end standalone_50m_mmcm;

architecture STRUCTURE of standalone_50m_mmcm is
begin
inst: entity work.standalone_50m_mmcm_standalone_50m_mmcm_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      clk_out2 => clk_out2,
