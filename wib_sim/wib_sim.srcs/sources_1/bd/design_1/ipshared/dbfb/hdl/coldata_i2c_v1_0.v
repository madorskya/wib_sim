...
`timescale 1 ns / 1 ps
	...
	(
        ...
        parameter integer bit_duration = 90, // duration of one bit in clocks 
        parameter integer ack_timeout  = 500, // timeout for ack from coldata 
        parameter integer scl_up   = 20, // start of scl pulse 
        parameter integer scl_down = 65, // end of scl pulse 
