...
-- Command     : write_vhdl -force -mode funcsim -rename_top design_1_pdts_endpoint_0_0 -prefix
--               design_1_pdts_endpoint_0_0_ design_1_pdts_endpoint_0_0_sim_netlist.vhdl
...
entity design_1_pdts_endpoint_0_0_outputlogic_crc16 is
  port (
...
end design_1_pdts_endpoint_0_0_outputlogic_crc16;

architecture STRUCTURE of design_1_pdts_endpoint_0_0_outputlogic_crc16 is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_pdts_endpoint_0_0_pdts_dec8b10b is
  port (
...
end design_1_pdts_endpoint_0_0_pdts_dec8b10b;

architecture STRUCTURE of design_1_pdts_endpoint_0_0_pdts_dec8b10b is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_pdts_endpoint_0_0_pdts_synchro is
  port (
    Q : in STD_LOGIC_VECTOR ( 0 to 0 );
    rec_clk : in STD_LOGIC;
    sclk : in STD_LOGIC
  );
end design_1_pdts_endpoint_0_0_pdts_synchro;

architecture STRUCTURE of design_1_pdts_endpoint_0_0_pdts_synchro is
  signal da : STD_LOGIC;
  signal db : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \design_1_pdts_endpoint_0_0_pdts_synchro__parameterized0\ is
  port (
    E : out STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute ORIG_REF_NAME of \design_1_pdts_endpoint_0_0_pdts_synchro__parameterized0\ : entity is "pdts_synchro";
end \design_1_pdts_endpoint_0_0_pdts_synchro__parameterized0\;

architecture STRUCTURE of \design_1_pdts_endpoint_0_0_pdts_synchro__parameterized0\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \design_1_pdts_endpoint_0_0_pdts_synchro__parameterized1\ is
  port (
    \out\ : out STD_LOGIC;
    sclk : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \design_1_pdts_endpoint_0_0_pdts_synchro__parameterized1\ : entity is "pdts_synchro";
end \design_1_pdts_endpoint_0_0_pdts_synchro__parameterized1\;

architecture STRUCTURE of \design_1_pdts_endpoint_0_0_pdts_synchro__parameterized1\ is
  signal da : STD_LOGIC;
  signal db : STD_LOGIC;
  attribute async_reg : string;
  attribute async_reg of db : signal is "yes";
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \design_1_pdts_endpoint_0_0_pdts_synchro__parameterized2\ is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \design_1_pdts_endpoint_0_0_pdts_synchro__parameterized2\ : entity is "pdts_synchro";
end \design_1_pdts_endpoint_0_0_pdts_synchro__parameterized2\;

architecture STRUCTURE of \design_1_pdts_endpoint_0_0_pdts_synchro__parameterized2\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_pdts_endpoint_0_0_pdts_tstamp is
  port (
...
end design_1_pdts_endpoint_0_0_pdts_tstamp;

architecture STRUCTURE of design_1_pdts_endpoint_0_0_pdts_tstamp is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_pdts_endpoint_0_0_pdts_cksum is
  port (
    D : out STD_LOGIC_VECTOR ( 1 downto 0 );
...
end design_1_pdts_endpoint_0_0_pdts_cksum;

architecture STRUCTURE of design_1_pdts_endpoint_0_0_pdts_cksum is
begin
crc: entity work.design_1_pdts_endpoint_0_0_outputlogic_crc16
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_pdts_endpoint_0_0_pdts_ep_startup is
  port (
    \out\ : out STD_LOGIC;
...
end design_1_pdts_endpoint_0_0_pdts_ep_startup;

architecture STRUCTURE of design_1_pdts_endpoint_0_0_pdts_ep_startup is
...
sync_clk: entity work.\design_1_pdts_endpoint_0_0_pdts_synchro__parameterized2\
     port map (
...
sync_rec_clk: entity work.\design_1_pdts_endpoint_0_0_pdts_synchro__parameterized1\
     port map (
...
sync_sclk: entity work.\design_1_pdts_endpoint_0_0_pdts_synchro__parameterized0\
     port map (
      D(3) => sync_sclk_n_1,
      D(2) => sync_sclk_n_2,
      D(1) => sync_sclk_n_3,
...
sync_t: entity work.design_1_pdts_endpoint_0_0_pdts_synchro
     port map (
      Q(0) => rctr_reg(4),
      rec_clk => rec_clk,
      sclk => sclk
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_pdts_endpoint_0_0_pdts_rx_phy is
  port (
    k : out STD_LOGIC;
    stb : out STD_LOGIC;
    D : out STD_LOGIC_VECTOR ( 9 downto 0 );
...
end design_1_pdts_endpoint_0_0_pdts_rx_phy;

architecture STRUCTURE of design_1_pdts_endpoint_0_0_pdts_rx_phy is
  signal c : STD_LOGIC;
  signal c0 : STD_LOGIC;
...
dec: entity work.design_1_pdts_endpoint_0_0_pdts_dec8b10b
     port map (
      D(9 downto 0) => D(9 downto 0),
      E(0) => \^stb\,
      Q(0) => Q(0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_pdts_endpoint_0_0_pdts_rx is
  port (
...
end design_1_pdts_endpoint_0_0_pdts_rx;

architecture STRUCTURE of design_1_pdts_endpoint_0_0_pdts_rx is
...
cksum: entity work.design_1_pdts_endpoint_0_0_pdts_cksum
     port map (
      D(1) => state(1),
      D(0) => cksum_n_1,
      E(0) => cksum_n_13,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_pdts_endpoint_0_0_pdts_endpoint is
  port (
...
end design_1_pdts_endpoint_0_0_pdts_endpoint;

architecture STRUCTURE of design_1_pdts_endpoint_0_0_pdts_endpoint is
...
begin
  ...
  sync_v <= \^sync_v\;
rx: entity work.design_1_pdts_endpoint_0_0_pdts_rx
     port map (
...
rxphy: entity work.design_1_pdts_endpoint_0_0_pdts_rx_phy
     port map (
      D(9) => \cksum/crc/lfsr_c\(15),
      D(8 downto 4) => \cksum/crc/lfsr_c\(8 downto 4),
      D(3) => rxphy_n_8,
...
startup: entity work.design_1_pdts_endpoint_0_0_pdts_ep_startup
     port map (
      D(0) => rx_err_f,
      SR(0) => rxphy_n_23,
      cdr_lol => cdr_lol,
...
ts: entity work.design_1_pdts_endpoint_0_0_pdts_tstamp
     port map (
...
entity design_1_pdts_endpoint_0_0 is
  ...
  attribute NotValidForBitStream of design_1_pdts_endpoint_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_pdts_endpoint_0_0 : entity is "design_1_pdts_endpoint_0_0,pdts_endpoint,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_pdts_endpoint_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of design_1_pdts_endpoint_0_0 : entity is "package_project";
  attribute x_core_info : string;
  attribute x_core_info of design_1_pdts_endpoint_0_0 : entity is "pdts_endpoint,Vivado 2020.1";
end design_1_pdts_endpoint_0_0;

architecture STRUCTURE of design_1_pdts_endpoint_0_0 is
...
begin
  \^rec_clk\ <= rec_clk;
  clk <= \^rec_clk\;
U0: entity work.design_1_pdts_endpoint_0_0_pdts_endpoint
     port map (
      cdr_lol => cdr_lol,
      cdr_los => cdr_los,
      evtctr(31 downto 0) => evtctr(31 downto 0),
